                            ...
                            @foreach($category as $value)
                                ...
                                <tr>
                                   <td>{{$value->id}}</td>
                                    ...
                                    <td><a href="{!! url('admin/category/update') !!}/{{$value->id}}" class=""><i class="fa fa-pencil"/> Edit </a></td>
                                    <td><a href="{!! url('admin/category/delete') !!}/{{$value->id}}" class=""><i class="fa fa-trash"/> Delete</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
