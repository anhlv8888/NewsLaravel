...
@section("page-content")
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>Vai trò <small>Tất cả vai trò</small></h1>
        </div>
        <!-- END PAGE TITLE -->
        <!-- BEGIN PAGE TOOLBAR -->
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="index.html">Roles & Privilleges</a>
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp bold uppercase">Quản lý vai trò & đặc quyền</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
