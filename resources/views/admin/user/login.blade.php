...
<link href="{{ asset('admin/assets/admin/pages/css/login.css') }} " rel="stylesheet" type="text/css"/>
...
<link href="{{ asset('admin/assets/admin/layout/css/themes/default.css') }} " rel="stylesheet" type="text/css" id="style_color"/>
...
{{--<div class="logo">--}}
	{{--<a href="index.html">--}}
	{{--<img src="{{ asset('admin/assets/admin/layout4/img/logo-big.png')  }}" alt=""/>--}}
	{{--</a>--}}
{{--</div>--}}
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
...
{{--<script src="{{ asset('admin/assets/admin/pages/scripts/login.js') }}  " type="text/javascript"></script>--}}
<!-- END PAGE LEVEL SCRIPTS -->
{{--<script>--}}
